...
function solution_value(
    solution::TwoStageSpanningTreeSolution, instance::TwoStageSpanningTreeInstance
)
    return dot(solution.y, instance.first_stage_costs) +
           dot(solution.z, instance.second_stage_costs) / nb_scenarios(instance)
end
...
"""
function solution_from_first_stage_forest(
    forest::BitVector, instance::TwoStageSpanningTreeInstance
)
